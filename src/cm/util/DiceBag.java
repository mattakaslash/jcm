...
/**
 * Provides dice-rolling utilities.
 * 
...
public class DiceBag {
	 ...
	 * 
	 * @param diceExpr
	 *            the dice expression, e.g., 3d6+5
	 * @param numRolls
	 *            the number of times to roll the expression
